    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('perfil', models.CharField(choices=[('ADMIN', 'Administrador'), ('GESTOR', 'Gestor'), ('OPERADOR', 'Operador'), ('VISUALIZADOR', 'Visualizador')], default='OPERADOR', max_length=20, verbose_name='Perfil')),
